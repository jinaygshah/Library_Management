	...
	<main class="d-flex flex">
		<div class="d-flex flex-column flex-shrink-0 p-3 bg-dark"
			...
			<ul class="nav nav-pills flex-column mb-auto">
				...
				<li><hr class="dropdown-divider"></li>
				<li><a href="AdminReturnBook.jsp" class="nav-link text-white active"> Return Books </a>
				</li>
				<li><hr class="dropdown-divider"></li>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="card card-bordered"
						style="width: 30rem; margin-left: 425px; box-shadow: 2px 4px rgba(0, 0, 0, 0.5);">
						<div class="card-body">
							<form action="AdditionalReturn.jsp" class="row g-3">
								<div class="col-auto">
									<label for="staticEmail2" class="form-control-plaintext">Student
										Id</label>
								</div>
								<div class="col-auto">
									<input type="number" name="stu_id" class="form-control" id="inputPassword2"
